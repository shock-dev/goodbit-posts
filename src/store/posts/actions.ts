...
export const fetchDeletingPost = (id: string) => action(PostsActionType.FETCH_DELETING_POST, id);
...
export const deletePost = (id: string) => action(PostsActionType.DELETE_POST, id);
